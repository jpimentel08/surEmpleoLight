<?php
//include('connectDB/_login.php'); // Includes Login Script
        ...
        <div class="container">
          <div class="cont-logear">
            ...
            <div class="form-logear">
              <form action="connectDB/check-login.php" method="post">
                <div class="coll-logear">
                  <input type="text" name="email" value="" placeholder="Ingrese su Rut o Email">
                ...
                <div class="coll-logear">
                  <button type="submit" name="button" class="button-ap">ENTRAR <!--<a href="postulantes-a.php">ENTRAR</a>--></button>
