           ...
           <div class="form-logear">
              <form>
                <div class="coll-logear">
                  <img class="img-fluid" style="width: 30%; border-radius: 6em;" src="../img/check_nouser.png">
                  <h2 class="title-registro" style="color:#ffffff">Necesita iniciar sesión para acceder a esta página./h2>
                </div>
                
                <div class="coll-logear">
                  <h4 class="title-registro">Por favor iniciar sesión!</h4>
                </div>
                
                <div class="coll-logear">
                  <a href="../login-postulante.php"><button type="button" name="button" class="button-ap">Iniciar Sesión</button></a>
                </div>
              </form>
            </div>
          </div>
