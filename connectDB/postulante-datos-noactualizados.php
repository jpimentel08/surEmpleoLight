           ...
           <div class="form-logear">
              <form>
                <div class="coll-logear">
                  <img class="img-fluid" style="width: 30%; border-radius: 6em;" src="../img/x-button.png">
                  <h2 class="title-registro" style="color:#ffffff">Datos no Actualizados..</h2>
                  <h4 class="title-registro"><?$_POST['name']?></h4>
                </div>
                
                <div class="coll-logear">
                  <h4 class="title-registro">Por favor verificar que los datos sean correctos..</h4>
                </div>
